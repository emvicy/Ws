...
_createClass(SvelteComponent,[{key:"$destroy",value:function $destroy(){destroy_component(this,1);this.$destroy=noop;}},{key:"$on",value:function $on(type,callback){var callbacks=this.$$.callbacks[type]||(this.$$.callbacks[type]=[]);callbacks.push(callback);return function(){var index=callbacks.indexOf(callback);if(index!==-1)callbacks.splice(index,1);};}},{key:"$set",value:function $set($$props){if(this.$$set&&!is_empty($$props)){this.$$.skip_bound=true;this.$$set($$props);this.$$.skip_bound=false;}}}]);return SvelteComponent;}();function create_if_block(ctx){var div1;var div0;var div0_class_value;var div0_style_value;var div1_class_value;return{c:function c(){div1=element("div");div0=element("div");attr(div0,"class",div0_class_value="pnotify-countdown-bar ".concat(ctx[0].getStyle("countdown-bar")));attr(div0,"style",div0_style_value="height: ".concat(ctx[1]==="right"||ctx[1]==="left"?ctx[3]:"100","%; width: ").concat(ctx[1]==="top"||ctx[1]==="bottom"?ctx[3]:"100","%;"));attr(div1,"class",div1_class_value="pnotify-countdown pnotify-countdown-".concat(ctx[1]," ").concat(ctx[2]?"pnotify-countdown-reverse":""," ").concat(ctx[0].getStyle("countdown")));},m:function m(target,anchor){insert(target,div1,anchor);append(div1,div0);},p:function p(ctx,dirty){if(dirty&1&&div0_class_value!==(div0_class_value="pnotify-countdown-bar ".concat(ctx[0].getStyle("countdown-bar")))){attr(div0,"class",div0_class_value);}
if(dirty&10&&div0_style_value!==(div0_style_value="height: ".concat(ctx[1]==="right"||ctx[1]==="left"?ctx[3]:"100","%; width: ").concat(ctx[1]==="top"||ctx[1]==="bottom"?ctx[3]:"100","%;"))){attr(div0,"style",div0_style_value);}
if(dirty&7&&div1_class_value!==(div1_class_value="pnotify-countdown pnotify-countdown-".concat(ctx[1]," ").concat(ctx[2]?"pnotify-countdown-reverse":""," ").concat(ctx[0].getStyle("countdown")))){attr(div1,"class",div1_class_value);}},d:function d(detaching){if(detaching)detach(div1);}};}
function create_fragment(ctx){var if_block_anchor;var if_block=ctx[4]&&create_if_block(ctx);return{c:function c(){if(if_block)if_block.c();if_block_anchor=empty();},m:function m(target,anchor){if(if_block)if_block.m(target,anchor);insert(target,if_block_anchor,anchor);},p:function p(ctx,_ref){var _ref2=_slicedToArray(_ref,1),dirty=_ref2[0];if(ctx[4]){if(if_block){if_block.p(ctx,dirty);}else{if_block=create_if_block(ctx);if_block.c();if_block.m(if_block_anchor.parentNode,if_block_anchor);}}else if(if_block){if_block.d(1);if_block=null;}},i:noop,o:noop,d:function d(detaching){if(if_block)if_block.d(detaching);if(detaching)detach(if_block_anchor);}};}
var position="AppendContainer";var defaults={anchor:"bottom",reverse:false};function instance($$self,$$props,$$invalidate){var _$$props$self=$$props.self,self=_$$props$self===void 0?null:_$$props$self;var _$$props$anchor=$$props.anchor,anchor=_$$props$anchor===void 0?defaults.anchor:_$$props$anchor;var _$$props$reverse=$$props.reverse,reverse=_$$props$reverse===void 0?defaults.reverse:_$$props$reverse;var _state=self.getState();var _timer=self.getTimer();var _msLeft=0;var _percent=100;var ival;var offUpdate;var offAfterOpen;var getValues=function getValues(){$$invalidate(5,_state=self.getState());$$invalidate(6,_timer=self.getTimer());};onMount(function(){offUpdate=self.on("pnotify:update",getValues);offAfterOpen=self.on("pnotify:afterOpen",getValues);ival=setInterval(function(){if(showCountdown){if(timeStart){_msLeft=self.delay-(new Date()-timeStart);$$invalidate(3,_percent=_msLeft/self.delay*100);}else{$$invalidate(3,_percent=_state==="closing"?0:100);}}},100);});onDestroy(function(){offUpdate&&offUpdate();offAfterOpen&&offAfterOpen();clearInterval(ival);});$$self.$$set=function($$props){if("self"in $$props)$$invalidate(0,self=$$props.self);if("anchor"in $$props)$$invalidate(1,anchor=$$props.anchor);if("reverse"in $$props)$$invalidate(2,reverse=$$props.reverse);};var showCountdown;var timeStart;$$self.$$.update=function(){if($$self.$$.dirty&33){$$invalidate(4,showCountdown=["opening","open","closing"].indexOf(_state)!==-1&&self.hide&&self.delay!==Infinity);}
if($$self.$$.dirty&80){timeStart=showCountdown&&_timer&&_timer!=="prevented"?new Date():null;}
if($$self.$$.dirty&19){{self.removeModuleClass("elem","pnotify-with-countdown","pnotify-with-countdown-bottom","pnotify-with-countdown-top","pnotify-with-countdown-left","pnotify-with-countdown-right");if(showCountdown){self.addModuleClass("elem","pnotify-with-countdown","pnotify-with-countdown-".concat(anchor));}}}};return[self,anchor,reverse,_percent,showCountdown];}
var Countdown=function(_SvelteComponent){_inherits(Countdown,_SvelteComponent);var _super=_createSuper(Countdown);function Countdown(options){var _this;_classCallCheck(this,Countdown);_this=_super.call(this);init(_assertThisInitialized(_this),options,instance,create_fragment,safe_not_equal,{self:0,anchor:1,reverse:2});return _this;}
return Countdown;}(SvelteComponent);exports.default=Countdown;exports.defaults=defaults;exports.position=position;Object.defineProperty(exports,'__esModule',{value:true});})));