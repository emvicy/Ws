...
if(dirty&1&&div2_class_value!==(div2_class_value="pnotify-paginate-buttons ".concat(ctx[0].getStyle("paginate-buttons")))){attr(div2,"class",div2_class_value);}},d:function d(detaching){if(detaching)detach(div2);mounted=false;run_all(dispose);}};}
function create_if_block(ctx){var div;var span0;var t0;var span0_class_value;var t1;var span1;var t2_value=ctx[3].of+"";var t2;var span1_class_value;var t3;var span2;var t4;var span2_class_value;var div_class_value;return{c:function c(){div=element("div");span0=element("span");t0=text(ctx[4]);t1=space();span1=element("span");t2=text(t2_value);t3=space();span2=element("span");t4=text(ctx[5]);attr(span0,"class",span0_class_value="pnotify-paginate-count-current ".concat(ctx[0].getStyle("paginate-count-current")));attr(span1,"class",span1_class_value="pnotify-paginate-count-of ".concat(ctx[0].getStyle("paginate-count-of")));attr(span2,"class",span2_class_value="pnotify-paginate-count-total ".concat(ctx[0].getStyle("paginate-count-total")));attr(div,"class",div_class_value="pnotify-paginate-count ".concat(ctx[0].getStyle("paginate-count")));},m:function m(target,anchor){insert(target,div,anchor);append(div,span0);append(span0,t0);append(div,t1);append(div,span1);append(span1,t2);append(div,t3);append(div,span2);append(span2,t4);},p:function p(ctx,dirty){if(dirty&16)set_data(t0,ctx[4]);if(dirty&1&&span0_class_value!==(span0_class_value="pnotify-paginate-count-current ".concat(ctx[0].getStyle("paginate-count-current")))){attr(span0,"class",span0_class_value);}
